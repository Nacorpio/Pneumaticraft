...
public class TeleporterPneumansion extends Teleporter
{
 ...
 private final List destinationCoordinateKeys = new ArrayList();
  ...
  public TeleporterPneumansion(WorldServer par1WorldServer)
 {
 ...
 public void placeInPortal(Entity par1Entity, double par2, double par4, double par6, float par8)
 {
    ...
    for (int var14 = -2; var14 <= 2; ++var14)
   {
    for (int var15 = -2; var15 <= 2; ++var15)
    {
     for (int var16 = -1; var16 < 3; ++var16)
     {
      ...
      this.field_85192_a.setBlock(var17, var18, var19, var20 ? Pneumaticraft.eternalPowerConduit.blockID : 0);
     }
    }
   }
  ...
  public boolean placeInExistingPortal(Entity par1Entity, double par2, double par4, double par6, float par8)
  {
      ...
      else
      {
          for (k1 = l - short1; k1 <= l + short1; ++k1)
          {
              ...
              for (int l1 = i1 - short1; l1 <= i1 + short1; ++l1)
              {
                  ...
                  {
                      if (this.worldServerInstance.getBlockId(k1, i2, l1) == Pneumaticraft.pneumansionPortal.blockID)
                      {
                          while (this.worldServerInstance.getBlockId(k1, i2 - 1, l1) == Pneumaticraft.pneumansionPortal.blockID)
                          {
                              --i2;
                          }
      ...
      if (d3 >= 0.0D)
      {
          ...
          if (this.worldServerInstance.getBlockId(i - 1, j, k) == Pneumaticraft.pneumansionPortal.blockID)
          {
              j2 = 2;
          }
          ...
          if (this.worldServerInstance.getBlockId(i, j, k - 1) == Pneumaticraft.pneumansionPortal.blockID)
          {
              j2 = 3;
          }
          ...
          par1Entity.setLocationAndAngles(d8+2, d9, d4+2, par1Entity.rotationYaw, par1Entity.rotationPitch);
          return true;
      }
      else
      {
          ...
          for (k2 = -1; k2 <= 1; ++k2)
          {
              for (i3 = 1; i3 < 3; ++i3)
              {
                  for (l2 = -1; l2 < 3; ++l2)
                  {
                      ...
                      i4 = j2 + (i3 - 1) * l5 - k2 * k5;
                      flag = l2 < 0;
                      this.worldServerInstance.setBlock(k3, j3, i4, flag ? Pneumaticraft.eternalPowerConduit.blockID : 0);
                  }
              }
          }
      }
      ...
      for (k2 = 0; k2 < 4; ++k2)
      {
          for (i3 = 0; i3 < 4; ++i3)
          {
              for (l2 = -1; l2 < 4; ++l2)
              {
                  ...
                  this.worldServerInstance.setBlock(k3, j3, i4, flag ? Pneumaticraft.eternalPowerConduit.blockID : Pneumaticraft.pneumansionPortal.blockID, 0, 2);
              }
          }
